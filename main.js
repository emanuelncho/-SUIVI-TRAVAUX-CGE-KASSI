...
var Lotis=[6.70766, -5.18984]
var PLotis=[6.70605, -5.18924]
var LLotis=[6.69982, -5.19331]
...
function Mlotis() {
    ...
    L.geoJSON(Fondi).addTo(map);
    L.geoJSON(Logbakro).addTo(map);

    LotisFondi = L.marker(PLotis).bindPopup(" LOTISSEMENT FONDI ( 160ha 40a 91ca )")
    LotisLogbakro = L.marker(LLotis).bindPopup(" LOTISSEMENT LOGBAKRO ( 48ha 83a 50ca )")

    LotisFondi.addTo(map);
